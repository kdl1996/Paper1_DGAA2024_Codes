 %% D neq 0 saddle
 clear all;
  a1=-1;a2=-2;b1=-5;b2=-5;v10=0.5;v20=0.7;
 
 
  tspan = 0:0.1:500;


y0mat=[1 1;-1 -1;-0.5 -1; 0.5 1;0.4 1;0.7 1;0.6 1;0.8 1;0.9 1;-0.6 -1; -0.7 -1;-0.8 -1;-0.9 -1];
    x=-5:0.1:5;
 z=-0.707*x;
...
for k=1:size(y0mat,1)
plot(y1sol{k},y2sol{k},'k-');%,x,z,'r-','LineWidth',0.5
box on
end
 hold off
 legend(h1,'Attractor')
...
% 
% figure(2)
% plot(t,y1sol{4},'k-',t,y2sol{4},'k--','LineWidth',2);
